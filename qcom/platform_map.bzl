_platform_map = {
    ...
    "annibale": {
        ...
        "dtbo_list": [
            # keep sorted
            {"name": "annibale-sm8750-overlay.dtbo"},
        ],
    },
    "bixi": {
        "dtb_list": [
    ...
    "luming": {
        ...
        "dtbo_list": [
            # keep sorted
            {"name": "luming-sm8735-overlay.dtbo"},
        ],
    },
    "piano": {
        "dtb_list": [
        ...
        "dtbo_list": [
            # keep sorted
            {"name": "piano-sm8750-overlay.dtbo"},
        ],
    },
    "yupei": {
        "dtb_list": [
        ...
        "dtbo_list": [
            # keep sorted
            {"name": "yupei-sm8735-overlay.dtbo"},
        ],
    },
    "parrot-tuivm": {
        "dtb_list": [
